...
import { deletePerson, getPerson, getPeople, postPerson, updatePerson, giveMeSubjects,answerMyQuestion } from "../controllers/user";
...
router.get("/giveMe/:idUser",giveMeSubjects);
router.post("/answer",answerMyQuestion);
